  ...
  return (
    <>
      ...
      <div className="flex flex-col mt-8 page-container slide-in">
        ...
        <div>
          <p
            className="text-[12px] sm:text-[14px] md:text-[16px] lg:text-[18px] font-bold text-center mt-6"
            text="BUY, SELL & SWAP CRYPTO op"
          >
            Log in as
          </p>
        </div>
        <Link to="/buy-crypto" className="flex items-center">
          <button className="text-[12px] sm:text-[14px] md:text-[16px] lg:text-[18px] bg-[#0063BF] w-full sm:w-[292px] h-[54px] text-white mx-auto rounded-3xl cursor-pointer hover:animate-pulse font-bold op mt-6 ">
            User
          </button>
        </Link>
