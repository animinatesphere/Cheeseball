...
import { ArrowRight, Shield, Zap, Globe, Smartphone, CreditCard, ChevronRight } from "lucide-react";
      ...
      <nav className="fixed w-full z-50 bg-white/80 backdrop-blur-md border-b border-gray-100 transition-all duration-300">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-2">
             ...
             <span className="font-black text-xl tracking-tight text-blue-900 hidden sm:block">CHEESEBALL</span>
          </div>
          <div className="hidden md:flex items-center gap-8 font-bold text-sm text-gray-500">
            <a href="#features" className="hover:text-blue-600 transition-colors">Features</a>
            <a href="#rates" className="hover:text-blue-600 transition-colors">Rates</a>
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8 animate-fade-in-up">
            ...
            <h1 className="text-5xl lg:text-7xl font-black text-gray-900 tracking-tight leading-[1.1]">
              The <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-cyan-500">Fastest</span> Way to Trade Crypto.
            </h1>
            ...
            <div className="pt-8 border-t border-gray-100 flex items-center gap-8">
               <div>
                  ...
                  <p className="text-gray-400 text-xs font-bold uppercase tracking-widest">Active Users</p>
               </div>
               <div className="w-px h-10 bg-gray-100"></div>
               <div>
                  <p className="text-3xl font-black text-gray-900">$10M+</p>
                  <p className="text-gray-400 text-xs font-bold uppercase tracking-widest">Traded Volume</p>
               </div>
            </div>
          </div>
      ...
      <section id="features" className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-2xl mx-auto mb-20">
            <h2 className="text-4xl font-black text-gray-900 tracking-tight mb-4">Why Choose Cheeseball?</h2>
            <p className="text-gray-500 font-medium text-lg">We provide the most reliable infrastructure for your crypto journey.</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="bg-white p-8 rounded-[2.5rem] shadow-sm hover:shadow-xl transition-all border border-gray-100 hover:-translate-y-2">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="bg-[#0063BF] rounded-[3rem] p-12 lg:p-24 text-center relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-3xl mx-auto">
              <h2 className="text-4xl lg:text-6xl font-black text-white tracking-tight mb-8">Ready to start your journey?</h2>
              <p className="text-blue-100 text-xl font-medium mb-12">Join thousands of Nigerians who trust Cheeseball for their daily crypto transactions.</p>
              <button
                onClick={() => navigate("/auth")}
      ...
      <footer className="bg-gray-900 text-white pt-24 pb-12">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-12 mb-16">
            <div className="col-span-2">
              <div className="flex items-center gap-2 mb-6">
                 <img src={logo} alt="Cheeseball" className="h-8 w-auto brightness-0 invert" />
                 <span className="font-black text-xl tracking-tight">CHEESEBALL</span>
              </div>
            ...
            <div>
              <h4 className="font-black uppercase text-xs tracking-widest text-gray-500 mb-6">Company</h4>
            ...
            <div>
              <h4 className="font-black uppercase text-xs tracking-widest text-gray-500 mb-6">Legal</h4>
              <ul className="space-y-4 text-gray-400 font-medium">
          ...
          <div className="pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-500 text-sm font-bold">© 2024 Cheeseball. All rights reserved.</p>
