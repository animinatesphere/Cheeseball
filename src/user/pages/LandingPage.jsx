  ...
  const faqs = [
    {
      ...
      a: "Most transactions are processed instantly. Crypto sales typically hit your bank account within 2-5 minutes after network confirmation. We use automated smart routing for maximum speed.",
    },
    {
      q: "What are the trading limits?",
      a: "We support both small and high-volume trades. Limits start from $10 up to $50,000 daily, depending on your verification level. Contact support for higher limits.",
    },
    {
      q: "Is my money and personal data safe?",
      a: "Absolutely. We use bank-grade AES-256 encryption, two-factor authentication, and secure cold storage for digital assets. Your data is never shared with third parties.",
    },
    {
      q: "Which gift cards do you accept?",
      a: "We accept Apple/iTunes, Amazon, Steam, Google Play, Sephora, Nordstrom, Razer Gold, and many more. Check our app for the full list and current rates.",
    },
    {
      q: "How do I contact support?",
      a: "Our dedicated support team is available 24/7 via live chat in the app, or by emailing support@cheeseball.com. Average response time is under 5 minutes.",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-white font-sans overflow-x-hidden selection:bg-blue-500/30 selection:text-slate-900">
      ...
      <nav className="fixed w-full z-50 bg-white/80 backdrop-blur-2xl border-b border-black/5 transition-all">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 sm:h-20 flex items-center justify-between">
          <img
            src={logo}
            alt="Cheeseball"
            className="h-12 sm:h-16 w-auto rounded-full"
          />
          <div className="hidden md:flex items-center gap-8">
            <a
              href="#how"
              className="text-gray-600 hover:text-[#2563eb] font-bold text-sm transition-colors uppercase tracking-widest"
            >
              How it Works
            </a>
            <a
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="text-gray-600 font-bold text-sm hover:text-[#2563eb] transition-colors hidden sm:block uppercase tracking-widest cursor-pointer"
            >
              Sign In
            </button>
            <button
              onClick={() => navigate("/signup")}
              className="bg-[#2563eb] hover:bg-[#2563eb]/90 text-white px-5 sm:px-6 py-2.5 rounded-xl font-black text-sm transition-all hover:shadow-lg hover:shadow-[#2563eb]/20 active:scale-95 uppercase tracking-tighter cursor-pointer"
            >
              Get Started
            </button>
          </div>
        ...
        <div className="flex animate-marquee whitespace-nowrap gap-10 items-center">
          {[...marketData, ...marketData].map((item, i) => (
            <div key={i} className="flex items-center gap-2 text-[#0f172a]">
              <span className="font-bold text-xs opacity-50 uppercase">
                {item.coin}
              </span>
              <span className="font-black text-sm">{item.price}</span>
              <span
                className={`text-[10px] font-black px-1.5 py-0.5 rounded ${item.up ? "text-green-400" : "text-red-400"}`}
              >
                {item.up ? "▲" : "▼"} {item.change}
              </span>
            </div>
      ...
      <section className="relative pt-36 sm:pt-44 pb-16 sm:pb-24 overflow-hidden">
        ...
        <div className="absolute top-20 right-0 w-150 h-150 bg-blue-500/5 rounded-full blur-[120px] animate-blob"></div>
        <div className="absolute bottom-0 left-0 w-100 h-100 bg-cyan-500/5 rounded-full blur-[100px] animate-blob animation-delay-2000"></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div className="space-y-6 sm:space-y-8">
              ...
              <h1 className="fluid-h1 font-black text-slate-900 tracking-tighter leading-tight animate-fade-in-up">
                Buy, Sell &{" "}
                <span className="text-blue-600 italic">Swap Crypto</span>
                <br />
                Instantly.
              </h1>

              <p className="fluid-p text-slate-600 font-medium leading-relaxed max-w-lg animate-fade-in-up animation-delay-200">
                The most reliable platform to trade BTC, USDT and Gift Cards in
              ...
              <div className="flex items-center gap-6 pt-4 animate-fade-in-up animation-delay-600">
                <div className="flex -space-x-2">
                  {[...Array(4)].map((_, i) => (
                    <div
                      key={i}
                      className="w-10 h-10 rounded-full bg-linear-to-br from-gray-50 to-white border-2 border-blue-100 flex items-center justify-center text-blue-600 text-xs font-black"
                    >
            ...
            <div className="relative hidden lg:flex items-center justify-center h-137.5">
              <div className="absolute inset-0 flex items-center justify-center">
                {/* Central glow */}
                <div className="w-80 h-80 bg-linear-to-br from-[#2563eb]/20 to-[#2563eb]/5 rounded-full blur-[80px] opacity-50 animate-pulse-slow"></div>
              </div>
              ...
              <img
                src={btcIcon}
                alt="Bitcoin"
                className="absolute top-8 left-1/2 -translate-x-1/2 w-28 h-28 animate-float drop-shadow-2xl"
              />
              <img
                src={ethIcon}
                alt="Ethereum"
                className="absolute top-32 right-8 w-24 h-24 animate-float animation-delay-500 drop-shadow-xl"
              />
              <img
                src={usdtIcon}
                alt="USDT"
                className="absolute bottom-24 left-8 w-20 h-20 animate-float animation-delay-1000 drop-shadow-xl"
              />
              <img
                src={solIcon}
                alt="Solana"
                className="absolute bottom-8 right-16 w-22 h-22 animate-float animation-delay-1500 drop-shadow-xl"
                style={{ width: "5.5rem", height: "5.5rem" }}
              />
              <img
                src={appleGC}
                alt="Gift Card"
                className="absolute top-40 left-4 w-20 h-20 animate-float animation-delay-2000 drop-shadow-xl"
              />
      ...
      <section
        id="stats-section"
        className="py-16 sm:py-20 bg-gray-50 reveal border-y border-black/5"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-12 text-center">
            <div className="group">
              <p className="text-2xl sm:text-5xl lg:text-6xl font-black text-slate-900 mb-2 tabular-nums">
                {counter.users.toLocaleString()}+
              </p>
              <p className="text-blue-600 text-[10px] sm:text-xs font-black uppercase tracking-[0.2em]">
                Active Traders
              </p>
            </div>
            <div className="group">
      ...
      <section id="how" className="py-20 sm:py-28 overflow-hidden bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 relative">
            {/* Connection line */}
            <div className="hidden md:block absolute top-24 left-0 w-full h-px bg-linear-to-r from-transparent via-[#2563eb]/20 to-transparent z-0"></div>

            {[
              {
                step: "01",
                title: "Create Account",
                desc: "Sign up in 30 seconds with your email. No paperwork, no KYC delays.",
              ...
              },
              {
                ...
                desc: "Pick from crypto, gift cards, or swaps. Set your amount and get instant quotes.",
              ...
              },
              {
                ...
                desc: "Receive your payout in seconds. We support all Nigerian banks for instant transfers.",
              ...
              <div
                key={i}
                className={`relative z-10 text-center group reveal`}
                style={{ transitionDelay: `${i * 150}ms` }}
              >
                <div
                  className={`w-20 h-20 mx-auto bg-linear-to-br ${item.color} ${i === 2 ? "text-slate-900" : "text-blue-600"} rounded-3xl flex items-center justify-center mb-6 shadow-xl border border-black/5 group-hover:scale-110 group-hover:rotate-6 transition-all duration-500`}
                >
                  {item.icon}
                </div>
                <div className="text-5xl font-black text-slate-900/5 mb-2">
                  {item.step}
                </div>
                <h3 className="text-xl sm:text-2xl font-black text-slate-900 mb-3 uppercase tracking-tighter">
                  {item.title}
                </h3>
      ...
      <section id="features" className="py-20 sm:py-28 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center max-w-2xl mx-auto mb-16 reveal">
            ...
            <h2 className="fluid-h2 font-black text-slate-900 tracking-tight mb-4 uppercase">
              The Premium Choice.
            </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {/* Big Feature Card */}
            <div className="lg:col-span-2 bg-linear-to-br from-blue-600 via-blue-700 to-blue-800 rounded-4xl p-8 sm:p-12 text-white relative overflow-hidden group border border-white/5 hover:border-blue-400/30 transition-all reveal">
              ...
              <div className="relative z-10 max-w-md">
                ...
                <h3 className="text-2xl sm:text-3xl font-black mb-4 tracking-tighter uppercase italic text-white">
                  Lightning Execution
                </h3>
              ...
              <img
                src={mobilePay}
                alt=""
                className="absolute bottom-0 right-4 w-48 sm:w-64 opacity-20 grayscale group-hover:grayscale-0 group-hover:opacity-40 transition-all duration-700"
              />
            </div>

            <div className="bg-[#f1f3f5] rounded-4xl p-8 border border-white/5 hover:border-[#2563eb]/20 transition-all group reveal">
            ...
            {/* Big card 2 */}
            <div className="lg:col-span-2 bg-linear-to-br from-blue-600 to-indigo-600 rounded-4xl p-8 sm:p-12 text-white relative overflow-hidden group hover:shadow-2xl hover:shadow-blue-500/20 transition-all reveal">
              ...
              <div className="relative z-10 max-w-md">
                ...
                <h3 className="fluid-h2 font-black mb-4 tracking-tighter uppercase italic text-white">
                  Gift Card Hub
                </h3>
                <p className="text-blue-50 font-bold leading-relaxed text-base sm:text-lg">
                  Convert unused gift cards to Naira instantly. Premium rates
                  for Apple, Steam, AMEX and 20+ more.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div className="reveal">
              ...
              <h2 className="fluid-h2 font-black text-slate-900 tracking-tight mb-6">
                Premium{" "}
              ...
              <div className="bg-gray-50 rounded-3xl p-6 sm:p-8 border border-black/5">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                  {[
                    ...
                    <div
                      key={i}
                      className="bg-white rounded-2xl p-4 flex items-center gap-3 border border-black/5 hover:border-blue-300 hover:bg-white transition-all group cursor-default shadow-sm"
                    >
                      <div className="w-10 h-10 rounded-xl overflow-hidden shrink-0 flex items-center justify-center bg-gray-50 font-black text-xs text-blue-600 group-hover:scale-110 transition-transform border border-black/5">
                        {coin.img ? (
                          <img
                            src={coin.img}
                            alt=""
                      ...
                      <div className="min-w-0">
                        ...
                        <p
                          className={`text-[10px] font-black ${coin.change.startsWith("+") ? "text-green-400" : "text-red-400"}`}
                        >
                          {coin.change}
                        </p>
                      </div>
              ...
              <div className="bg-gray-50 rounded-3xl p-6 sm:p-8 border border-black/5">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                  {[
                    ...
                    <div
                      key={i}
                      className="bg-white rounded-2xl p-4 flex items-center gap-3 border border-black/5 hover:border-blue-400/30 hover:bg-white transition-all group cursor-default shadow-sm"
                    >
                      <div className="w-10 h-10 rounded-xl overflow-hidden shrink-0 flex items-center justify-center bg-gray-50 font-black text-[10px] text-blue-600 group-hover:scale-110 transition-transform border border-black/5">
                        {card.img ? (
                          <img
                            src={card.img}
                            alt=""
      ...
      <section className="py-20 sm:py-28 bg-blue-600 relative overflow-hidden reveal">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10 text-white">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <blockquote className="fluid-h2 font-black tracking-tighter mb-8 leading-snug uppercase italic">
              "Cheeseball transformed my trading experience. The Bybit-inspired
              interface is premium, and payouts hit my bank in less than 2
              minutes."
            </blockquote>
            <div>
              <p className="font-black text-lg uppercase tracking-widest text-white">
                Adewale O.
              </p>
              <p className="text-blue-100 text-xs font-black uppercase tracking-[0.2em]">
                Lagos, Nigeria • Verified High Volume Trader
              </p>
            </div>
          </div>
        </div>
              ...
              {faqs.map((faq, i) => (
                <div
                  ...
                  className={`border rounded-2xl transition-all overflow-hidden cursor-pointer ${
                    activeAccordion === i
                      ? "border-blue-500/30 bg-gray-50 shadow-2xl shadow-blue-500/10"
                ...
                >
                  <div className="flex justify-between items-center p-5 sm:p-6">
                    <h4
                      className={`font-black text-xs sm:text-sm pr-4 uppercase tracking-widest ${activeAccordion === i ? "text-blue-600" : "text-slate-900"}`}
                    >
                      {faq.q}
                    </h4>
                    <ChevronDown
      ...
      <section className="py-20 sm:py-28 bg-gray-50 reveal border-t border-black/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="bg-white rounded-4xl sm:rounded-[3rem] p-10 sm:p-16 lg:p-24 text-center relative overflow-hidden group border border-black/5">
            ...
            <div className="relative z-10 max-w-3xl mx-auto">
              <h2 className="fluid-h1 font-black text-slate-900 tracking-tighter mb-6 leading-tight uppercase italic">
                The World of <span className="text-blue-600">Top Rates</span>
                <br />
                Awaits You.
              </h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-8 sm:gap-12 mb-12">
            <div className="sm:col-span-2">
              <img
                src={logo}
                alt="Cheeseball"
                className="h-16 w-auto rounded-full mb-6 grayscale hover:grayscale-0 transition-all"
              />
              <p className="text-slate-500 font-medium max-w-sm text-sm leading-relaxed uppercase tracking-tighter">
                Nigeria's #1 Institutional Grade Exchange. Experience depth,
                speed, and security like never before.
              </p>
            </div>
            <div>
              <h4 className="font-black uppercase text-[10px] tracking-[0.3em] text-gray-600 mb-6">
                Trade
              </h4>
              ...
              <ul className="space-y-4 text-gray-500 font-black text-xs uppercase tracking-widest">
                <li>
                  <button
                    ...
                    className="hover:text-[#2563eb] transition-colors text-left font-black"
                  >
                    Terms
                  </button>
                </li>
          ...
          <div className="pt-8 border-t border-white/5 flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="text-gray-600 text-[10px] font-black uppercase tracking-[0.2em]">
              © {new Date().getFullYear()} CHEESEBALL • INSTITUTIONAL GRADE
              TRADING
            </p>
      ...
      <style>{`
        ...
        /* Fluid typography utilities for landing page */
        .fluid-h1 { font-size: clamp(2rem, 4.5vw + 0.5rem, 4.5rem); line-height: 1; }
        .fluid-h2 { font-size: clamp(1.5rem, 3.2vw + 0.4rem, 3rem); line-height: 1.05; }
        .fluid-p  { font-size: clamp(1rem, 1.6vw + 0.6rem, 1.125rem); }
