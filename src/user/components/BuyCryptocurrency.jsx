  ...
  return (
    <div className="min-h-screen bg-[#ffffff] text-slate-800 pb-32">
      ...
      <div className="max-w-3xl mx-auto px-4 mt-8">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#f1f3f5] border border-white/5 p-6 rounded-[2rem] focus-within:border-[#2563eb]/30 transition-all">
            <div className="flex justify-between items-center mb-6">
               ...
               <span className="text-[10px] font-bold text-[#2563eb] bg-[#2563eb]/10 px-2 py-0.5 rounded italic">Fiat Balance</span>
            </div>
            <div className="flex items-center gap-4">
               <div className="flex items-center gap-3 bg-[#e9ecef] px-4 py-2 rounded-xl group cursor-pointer hover:bg-[#363C45] transition-colors">
                  <span className="text-xl">{selectedFiat.icon}</span>
                  <select 
                    value={fromCurrency}
                    onChange={(e) => setFromCurrency(e.target.value)}
                    className="bg-transparent font-black text-lg outline-none cursor-pointer appearance-none text-slate-900 pr-2"
                  >
                    {fiatCurrencies.map(c => <option key={c.symbol} value={c.symbol} className="bg-[#f1f3f5]">{c.symbol}</option>)}
                  </select>
               </div>
               <input
                 type="number"
        ...
        <div className="mt-6 bg-[#f8f9fa]/50 border border-white/5 rounded-[2rem] p-6 focus-within:border-[#2563eb]/20 transition-all">
          <div className="flex items-center gap-4">
             ...
             <button 
               ...
               className="bg-[#2563eb] text-black text-[10px] font-black px-6 py-3 rounded-xl uppercase tracking-widest hover:bg-[#2563eb]/80 transition-all disabled:opacity-30"
             >
        ...
        <div className="mt-12 space-y-4">
           ...
           <button
            ...
            disabled={!sendAmount}
            className="w-full bg-[#2563eb] hover:bg-[#2563eb]/90 text-black py-6 rounded-[2rem] font-black text-xl shadow-2xl flex items-center justify-center gap-4 group transition-all disabled:opacity-30 active:scale-95"
          >
