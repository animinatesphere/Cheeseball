...
const SupportPage = ({ onNavigate }) => {
  ...
  return (
    <div className="min-h-screen bg-[#ffffff] text-slate-800 pb-32 uppercase tracking-tighter">
      <div className="bg-[#f8f9fa] border-b border-white/5 shadow-xl">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
          <h1 className="text-2xl sm:text-4xl font-black text-slate-900 italic">24/7 Global Support</h1>
          <p className="text-[#2563eb] text-[10px] sm:text-xs font-black uppercase tracking-[0.2em]">Institutional Grade Assistance</p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 mt-8 sm:mt-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12">
          ...
          <div className="bg-[#f1f3f5] rounded-[2.5rem] p-8 sm:p-12 border border-white/5 shadow-2xl relative overflow-hidden group">
            <div className="absolute top-0 right-0 w-64 h-64 bg-[#2563eb]/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2 group-hover:scale-150 transition-transform duration-700"></div>
            
            <div className="flex items-center justify-between mb-10 relative z-10">
               <div className="p-4 bg-white/5 rounded-2xl text-[#2563eb] shadow-lg border border-white/5">
                 <MessageCircle className="w-8 h-8" />
               </div>
               <div className="text-right">
                 <h2 className="text-xl sm:text-2xl font-black text-slate-900 italic leading-none mb-1 uppercase tracking-tighter">Live Chat</h2>
            ...
            <button className="w-full bg-white/5 rounded-3xl p-6 sm:p-8 flex items-center gap-6 hover:bg-white/10 transition-all border border-white/5 group relative z-10">
              <div className="w-12 h-12 sm:w-16 sm:h-16 bg-green-500 rounded-2xl flex items-center justify-center text-slate-900 shadow-lg shadow-green-500/20 group-hover:scale-110 transition-transform shrink-0">
              ...
              <div className="flex-1 text-left min-w-0">
                <p className="text-lg sm:text-xl font-black text-slate-900 italic leading-none mb-1 truncate uppercase">WhatsApp Support</p>
                <p className="text-gray-500 font-bold text-xs sm:text-sm truncate">+234 901 2345 678</p>
              </div>
              <ChevronRight className="text-[#2563eb] shrink-0" size={24} />
            </button>
          </div>

          <div className="space-y-6 sm:space-y-8">
            {/* Address Book Card — Updated for Dark Theme */}
            <div className="bg-[#f1f3f5] rounded-[2rem] p-8 border border-white/5 shadow-xl">
              ...
              >
                <div className="flex items-center gap-4">
                   ...
                   <span className="text-lg font-black text-slate-900 italic uppercase tracking-tighter">Verified Addresses</span>
                </div>
                <ChevronRight className="text-gray-600 group-hover:text-[#2563eb] transition-all shrink-0" size={20} />
              </button>
            </div>
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={i} className="bg-white/5 p-6 rounded-2xl flex items-center justify-between border border-white/5 group">
                    <span className="text-base font-black text-slate-600 uppercase tracking-tighter">{item.label}</span>
                    <button
                      onClick={() => item.setState(!item.state)}
                      className={`w-14 h-8 rounded-full transition-all relative shrink-0 border border-white/10 ${
                        item.state ? "bg-[#2563eb] shadow-lg shadow-[#2563eb]/20" : "bg-[#e9ecef]"
                      }`}
                    >
