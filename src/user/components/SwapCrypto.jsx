    ...
    <div className="min-h-screen bg-[#0B0E11] text-[#EAECEF] pb-32">
      <div className="bg-[#181A20] px-4 py-6 border-b border-white/5 sticky top-0 z-50">
        <div className="max-w-3xl mx-auto flex items-center gap-4">
          ...
          <h1 className="text-xl font-black uppercase tracking-tight">Convert</h1>
        </div>
      </div>

      <div className="max-w-3xl mx-auto px-4 mt-8">
        <div className="flex bg-[#1E2329] p-1 rounded-2xl border border-white/5 mb-8">
          <button className="flex-1 py-3 rounded-xl bg-[#2B3139] text-[#FFB11A] font-black text-sm uppercase tracking-widest shadow-lg">
            Crypto
          </button>
          <button onClick={() => onNavigate("giftcard-swap")} className="flex-1 py-3 rounded-xl text-gray-500 font-bold text-sm uppercase tracking-widest hover:text-gray-300 transition-colors">
            Gift Card
          </button>
        </div>

        <div className="bg-[#1E2329] border border-white/5 rounded-[2.5rem] p-8 shadow-2xl relative overflow-hidden group">
           <div className="absolute top-0 right-0 w-40 h-40 bg-[#FFB11A]/5 rounded-full blur-3xl opacity-0 group-hover:opacity-100 transition-opacity"></div>
           
           <div className="space-y-6 relative z-10">
              {/* FROM */}
              <div className="bg-[#2B3139]/50 border border-white/5 p-6 rounded-[2rem]">
                 <div className="flex justify-between items-center mb-6 px-1">
                    <span className="text-[10px] font-black uppercase text-gray-500 tracking-widest">From</span>
                    <span className="text-[10px] font-bold text-[#FFB11A]">Balance: {currentBalance.toLocaleString()} {fromCurrency}</span>
                 </div>
                 <div className="flex items-center gap-4">
                   <div className="flex items-center gap-3 bg-[#181A20] px-4 py-2 rounded-xl group cursor-pointer hover:bg-[#2B3139] transition-colors max-w-[140px]">
                   ...
                   <input
                     ...
                     className="flex-1 bg-transparent text-right text-3xl font-black outline-none text-white placeholder-gray-800"
                   />
                 </div>
              </div>

              <div className="flex justify-center -my-10 relative z-20">
                 <button className="w-12 h-12 bg-[#FFB11A] text-black border-4 border-[#0B0E11] rounded-2xl flex items-center justify-center hover:rotate-180 active:scale-90 transition-all duration-500 shadow-2xl">
           ...
           <div className="mt-12 space-y-4">
              <div className="bg-[#2B3139]/30 border border-white/5 p-4 rounded-2xl flex items-center justify-between">
                 ...
                 <Zap className="w-4 h-4 text-[#FFB11A]" />
              </div>
              ...
              <button
                ...
                className="w-full bg-[#FFB11A] hover:bg-[#ffb11a]/90 text-black py-6 rounded-[2rem] font-black text-xl shadow-2xl transition-all flex items-center justify-center gap-4 group disabled:opacity-30 active:scale-95"
              >
