        ...
        <div className="max-w-3xl mx-auto mt-6 sm:mt-8">
          ...
          <div className="bg-gray-50 rounded-[2rem] sm:rounded-[3rem] p-6 sm:p-8 lg:p-12 border border-gray-100 shadow-sm mb-8 sm:mb-12">
            <div className="flex flex-col md:flex-row items-center justify-between gap-6 sm:gap-8">
              <div className="flex items-center gap-4 sm:gap-6 w-full md:w-auto">
                <div className="w-12 h-12 sm:w-16 sm:h-16 bg-green-500 rounded-xl sm:rounded-2xl flex items-center justify-center text-slate-900 font-black text-lg sm:text-xl shadow-lg shadow-green-100 shrink-0 overflow-hidden">
                ...
                <div>
                  <p className="text-slate-500 font-black uppercase text-[10px] sm:text-xs tracking-widest mb-1">Send</p>
              ...
              <div className="flex items-center gap-4 sm:gap-6 w-full md:w-auto">
                <div className="w-12 h-12 sm:w-16 sm:h-16 bg-orange-500 rounded-xl sm:rounded-2xl flex items-center justify-center text-slate-900 text-2xl sm:text-3xl shadow-lg shadow-orange-100 shrink-0 overflow-hidden">
                ...
                <div className="text-left md:text-left flex-1 md:flex-none">
                  <p className="text-slate-500 font-black uppercase text-[10px] sm:text-xs tracking-widest mb-1">Receive</p>
          ...
          <div className="mb-8 sm:mb-12 text-sm sm:text-base">
            ...
            <div className="relative group flex flex-col gap-4 sm:block">
              ...
              <button 
                onClick={handlePaste}
                className="sm:absolute sm:right-3 sm:top-1/2 sm:transform sm:-translate-y-1/2 flex items-center justify-center gap-2 bg-[#0063BF] text-slate-900 font-black px-6 py-4 rounded-xl sm:rounded-[1.5rem] hover:bg-blue-700 transition-all shadow-lg shadow-blue-100 active:scale-95"
              >
                <span>Paste</span>
                <Copy className="w-4 h-4" />
              </button>
            </div>
            <p className="text-[11px] sm:text-xs text-slate-500 font-medium mt-4 px-4 leading-relaxed">
          ...
          <button
            ...
            className="w-full bg-[#0063BF] hover:bg-blue-700 text-slate-900 py-5 sm:py-6 rounded-[1.5rem] sm:rounded-[2rem] font-black text-lg sm:text-xl shadow-2xl shadow-blue-200 transform hover:-translate-y-1 transition-all flex items-center justify-center gap-4 group disabled:opacity-70 disabled:cursor-not-allowed"
          >
             {loading ? (
                <>
