      ...
      <div className="max-w-7xl mx-auto px-6 mt-12">
        <div className="max-w-3xl mx-auto bg-gray-50 rounded-[3rem] p-10 lg:p-14 border border-gray-100 shadow-sm">
          <div className="mb-12">
            ...
            <div className="p-4 bg-orange-50 border border-orange-100 rounded-2xl flex items-center gap-4">
              <div className="w-10 h-10 bg-orange-600 rounded-xl flex items-center justify-center text-slate-900 shrink-0">
          ...
          <div className="space-y-10">
            <div>
              <label className="text-slate-500 font-black uppercase text-xs tracking-widest mb-4 block px-2">First Name</label>
              <input
                type="text"
                value={firstName}
            ...
            <div>
              <label className="text-slate-500 font-black uppercase text-xs tracking-widest mb-4 block px-2">Last Name</label>
              <input
                type="text"
                value={lastName}
            ...
            <button
              onClick={onContinue}
              className="w-full bg-[#0063BF] hover:bg-blue-700 text-slate-900 py-6 rounded-[2rem] font-black text-xl shadow-2xl shadow-blue-200 transform hover:-translate-y-1 transition-all flex items-center justify-center gap-4 group mt-8"
            >
        ...
        <div className="mt-12 text-center">
          <div className="inline-flex items-center gap-3 grayscale opacity-40 hover:grayscale-0 hover:opacity-100 transition-all cursor-default">
            <span className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-500">Security powered by</span>
