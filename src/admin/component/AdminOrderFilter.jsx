      ...
      <div className="bg-white rounded-t-[2.5rem] sm:rounded-[3rem] w-full max-w-lg shadow-2xl animate-slide-up sm:animate-bounce-in h-fit overflow-hidden">
        <div className="p-8 sm:p-10">
          ...
          <div className="space-y-8">
            <div>
              <label className="block text-[10px] font-black uppercase text-slate-500 tracking-widest mb-4 px-1">
                Time Horizon
              </label>
                ...
                {["All", "Today", "Week", "Month"].map((filter) => (
                  <button
                    ...
                    className={`px-6 py-3 rounded-2xl font-black text-[10px] uppercase tracking-widest transition-all ${
                      filterDate === filter
                        ? "bg-blue-600 text-slate-900 shadow-lg shadow-blue-100"
                        : "bg-gray-50 text-slate-500 hover:text-gray-600 hover:bg-gray-100"
                    }`}
                  >
                    {filter}
                  </button>
                ...
                <div className="flex-1">
                  <div className="relative group cursor-pointer">
                    <input
                      ...
                      readOnly
                    />
                    <Calendar className="absolute right-4 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-500 group-hover:text-blue-600 transition-colors" />
                  </div>
                </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="bg-gray-50 rounded-[1.5rem] p-4 flex items-center justify-between group cursor-pointer hover:bg-white hover:shadow-xl hover:border-blue-50 border border-transparent transition-all">
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 bg-orange-500 rounded-xl flex items-center justify-center text-slate-900 font-black text-xl shadow-lg shadow-orange-50 group-hover:scale-110 transition-transform">
                      ₿
                    </div>
                    <div>
                      <div className="font-black text-gray-900">Bitcoin</div>
                      <div className="text-[10px] font-black text-slate-500 uppercase tracking-widest leading-none mt-1">BTC</div>
                    </div>
                  </div>
                ...
                <div className="bg-gray-50 rounded-[1.5rem] p-4 flex items-center justify-between group cursor-pointer hover:bg-white hover:shadow-xl hover:border-blue-50 border border-transparent transition-all">
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 bg-blue-500 rounded-xl flex items-center justify-center text-slate-900 font-black text-xl shadow-lg shadow-blue-50 group-hover:scale-110 transition-transform">
                      T
                    </div>
                    <div>
                      <div className="font-black text-gray-900">Tether</div>
                      <div className="text-[10px] font-black text-slate-500 uppercase tracking-widest leading-none mt-1">TRC-20</div>
                    </div>
                  </div>
                  <ChevronRight className="w-5 h-5 text-blue-600 rotate-90" />
                </div>
            ...
            <button className="w-full text-slate-500 font-bold uppercase text-[10px] tracking-[0.3em] hover:text-blue-600 transition-colors">
