...
function WalletVariant({
  ...
  useEffect(() => {
    getWallets()
      .then((wallets) => {
        const ngn = Array.isArray(wallets)
          ? wallets.find((w) => w.asset === "NGN")
          : null;
  ...
  const hasSufficientBalance =
    walletBalance === null || walletBalance >= payAmount;
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Review and confirm your instant NGN wallet payment.
        </p>
        ...
        <div
          style={{
            marginTop: 16,
            background: hasSufficientBalance ? "#F0FDF4" : T.redLight,
            border: `1.5px solid ${hasSufficientBalance ? "#DCFCE7" : "#FECACA"}`,
            borderRadius: 16,
            padding: "20px 22px",
            display: "flex",
            alignItems: "center",
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
            ...
            <div>
              <p
                style={{
                  fontSize: 13,
                  color: hasSufficientBalance ? "#166534" : T.red,
                  fontFamily: "'DM Sans',sans-serif",
                }}
              >
                Available balance
          ...
          <div
            style={{
              ...
              gap: 5,
              padding: "6px 14px",
              background: hasSufficientBalance ? "#DCFCE7" : "#FECACA",
              borderRadius: 999,
            }}
          >
            ...
            <span
              style={{
                fontSize: 12,
                fontWeight: 600,
                color: hasSufficientBalance ? "#15803D" : T.red,
                fontFamily: "'DM Sans',sans-serif",
              }}
            >
        ...
        >
          <GhostBtn onClick={prevStep} style={{ flex: 1 }}>
            ← Back
          </GhostBtn>
          <CTA
            onClick={handlePay}
...
function PaystackVariant({
  ...
  return (
    <div style={{ background: T.white, minHeight: "100vh", width: "100%" }}>
      <style>{`@media(max-width:540px){ .bank-details .bank-row{flex-direction:column;align-items:flex-start;} .bank-details .bank-row div{margin-top:8px;} .bank-details .bank-row span{word-break:break-word;text-align:left;} }`}</style>
      <div className="step-content" style={{ padding: "44px 52px 0" }}>
        {breadcrumbs}
      </div>
      <div
        className="step-content"
        ...
        >
          ...
          >
            ...
            <div>
              ...
              >
                A virtual bank account will be generated for your payment
              </p>
            </div>
          </div>
            ...
            <div style={{ marginBottom: 20 }}>
              ...
              >
                {[
                  [
                    "Bank",
                    typeof bankDetails.bank === "object"
                      ? bankDetails.bank.name
                      : bankDetails.bank,
                  ],
                  ["Account Number", bankDetails.account_number, true],
                  ["Amount", formatNGN(payAmount)],
                  ...(bankDetails.display_text
                    ? [["Note", bankDetails.display_text]]
                    : []),
                ]
                  .filter((r) => r[1])
                  .map(([l, v, copy], i) => (
          ...
          {polling && (
            ...
            >
              ...
              >
                {statusMessages[pollStatus] || "Monitoring for your payment…"}
              </p>
            </div>
          )}
          ...
          {pollStatus === "failed" || pollStatus === "rejected" ? (
            ...
            >
              ...
              >
                Payment failed or was rejected. Please go back and try again.
              </p>
            </div>
          ) : null}
          ...
          {expiryTime > 0 && !setupDone && (
            ...
            >
              ...
              >
                Rate expires in {formatTime(expiryTime)}
              </span>
            </div>
          )}
          ...
          >
            Secure payment powered by Paystack. Crypto is delivered
...
function BankVariant({
  ...
  useEffect(() => {
    if (!bankInstructions) {
      getPaymentInstructions()
        .then((data) => setBankInstructions(data))
        .catch(() => {});
    }
  }, []);
      ...
      <div style={{ background: T.white, minHeight: "100vh", width: "100%" }}>
        ...
        >
          ...
          >
            ...
            >
              Transfer the exact amount below to complete your purchase
            </p>
            ...
            >
              {[
                ...
                [
                  "Account Number",
                  bankInstructions?.account_number || "Loading…",
                  true,
                ],
              ].map(([l, v, copy], i) => (
                <div
            ...
            >
              ...
              >
                After transferring, click "I Have Paid" to upload your proof of
                payment for faster review.
              </p>
            </div>
        ...
        >
          ...
          <div style={{ marginBottom: 16 }}>
            ...
            <input
              ...
              placeholder="e.g. your bank reference number"
              style={{
                width: "100%",
                border: `1.5px solid ${T.border}`,
                borderRadius: 12,
          ...
          <div
            ...
            style={{
              border: `2px dashed ${proofFile ? T.blue : T.border}`,
              borderRadius: 20,
              padding: "48px 24px",
              display: "flex",
              flexDirection: "column",
              ...
              textAlign: "center",
              cursor: "pointer",
              background: proofFile ? T.blueLight : T.surface,
