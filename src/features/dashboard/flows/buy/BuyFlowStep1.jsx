...
import { getBuyQuote, validatePromoCode } from "@/services/api";
...
export default function BuyFlowStep1({
  ...
  const handleContinue = async () => {
    ...
    setError(null);
    try {
      const quote = await getBuyQuote(selectedAsset.symbol, numericAmount);
      ...
      >
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              ...
              <input
                ...
                value={payAmount || ""}
                onChange={(e) => {
                  // Allow numbers and decimal, then format with commas for readability
                ...
                style={{
                  ...
                  fontWeight: 700,
                  color:
                    parseFloat((payAmount || "").toString().replace(/,/g, "")) >
                    0
                      ? T.text
                      : "#CED6E8",
        ...
        <div style={{ marginTop: 24 }}>
          <CTA
            ...
            disabled={!payAmount || Number(payAmount) < 1000 || loading}
          >
            {loading ? (
              <>
                <span
