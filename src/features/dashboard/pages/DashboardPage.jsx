        ...
        >
          {NAV_ITEMS.map((item) => {
            ...
            const active =
              currentPage === item.id ||
              (item.id === "dashboard" &&
                ["dashboard", "detail"].includes(currentPage));
            return (
              <button
                key={item.id}
                onClick={() => {
    ...
    try {
      ...
      if (isGiftCard) {
        ...
        const { error } = await createTransaction({
          ...
          from_token_network:
            finalData.type === "giftcard"
              ? finalData.cardName
              : finalData.fromCurrency,
            ...
            <main style={{ flex: 1, overflowY: "auto", position: "relative" }}>
              <Routes>
                ...
                <Route
                  ...
                  element={
                    <Navigate to="/currency-change/notifications" replace />
                  }
                />
                <Route
                  path="dashboard"
                ...
                <Route
                  path="confirm"
                  element={<Navigate to="/currency-change/swap" replace />}
                />
                <Route
                  path="awaiting"
                  element={
                    <AwaitingDeposit
                      ...
                      onContinue={(data) => {
                        ...
                        if (updatedData.type === "sell")
                          navigate("/currency-change/withdraw");
                ...
                <Route
                  path="giftcard-swap"
                  element={<SwapGiftCard onNavigate={handleNavigation} />}
                />
                <Route
                ...
                <Route
                  path="notifications"
                  element={<NotificationsPage onNavigate={handleNavigation} />}
                />
                <Route
                  path="history"
                ...
                <Route
                  path="account"
                  element={<SettingsPage onNavigate={handleNavigation} />}
                />
                <Route
                  path="support"
                  element={<SupportPage onNavigate={handleNavigation} />}
                />
                <Route
                  path="address-book"
                  element={
                    ...
                    >
                      <AddressBook
                        onBack={() => navigate("/currency-change/support")}
                      />
                    </div>
                  }
                />
                <Route
                  path="bank-accounts"
                  element={<BankAccounts onNavigate={handleNavigation} />}
                />
                <Route
                  path="kyc"
                  element={
