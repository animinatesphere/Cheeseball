      ...
      <div className="login-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", minHeight: "100vh", fontFamily: "'DM Sans', sans-serif" }}>
        ...
        <div className="form-panel" style={{ background: T.white, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "60px 72px", position: "relative" }}>
          ...
          <div className="form-container" style={{ width: "100%", maxWidth: 400 }}>
            ...
            {/* Social buttons */}
            <div className="fadein-4" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
              {[
                {
                  label: "Google",
                  icon: (
                ...
                <button
                  ...
                  style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 9, padding: "13px", borderRadius: 14, border: `1.5px solid ${T.border}`, background: T.white, cursor: "pointer", fontFamily: "'DM Sans', sans-serif", fontSize: 14, fontWeight: 600, color: T.text, transition: "all 0.15s" }}
                >
                  {icon} {label}
                </button>
              ))}
